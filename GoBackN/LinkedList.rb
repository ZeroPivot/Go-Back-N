...
class LinkedList
  ...
  def rightSentinelNode;@last;end
  def leftSentinelNode;@first;end
  def getFirstData;getFirstNode.object;end
  def getLastData;getLastNode.object;end
  ...
  def traverse
    #puts @first.next.object;exit
    traverseNode = getFirstNode
